...
for cost in $(seq 0.3 0.01 0.8)
do
    python3 ./Run.py -alg ATM_Robust            -m_cost $cost -env_var $rsmall -alpha_real $alpha_real -alpha_plan $alpha_real -env uMV2 -nmbr_eps $eps -nmbr_runs $runs -rep $folder_path &
    python3 ./Run.py -alg ATM_RMDP              -m_cost $cost -env_var $rsmall -alpha_real $alpha_real -alpha_plan $alpha_real -env uMV2 -nmbr_eps $eps -nmbr_runs $runs -rep $folder_path &
    python3 ./Run.py -alg ATM_Control_Robust    -m_cost $cost -env_var $rsmall -alpha_real $alpha_real -alpha_plan $alpha_real -env uMV2 -nmbr_eps $eps -nmbr_runs $runs -rep $folder_path &
    python3 ./Run.py -alg ATM_Control_Robust    -m_cost $cost -env_var $rsmall -alpha_real $alpha_real -alpha_plan $alpha_real -env uMV2 -nmbr_eps $eps -nmbr_runs $runs -rep $folder_path &
    python3 ./Run.py -alg ATM_Control_Robust    -m_cost $cost -env_var $rsmall -alpha_real $alpha_real -alpha_plan $alpha_real -env uMV2 -nmbr_eps $eps -nmbr_runs $runs -rep $folder_path &
    wait
done
